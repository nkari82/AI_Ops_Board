...
def _load_runtime_dependencies() -> tuple[Any, Any, dict[str, Any], Any, Any]:
    try:
    ...
    return config_module.settings, db_module.init_db, router_modules, llm_module.LLMRouter, llm_module.LLMRouterError


settings, init_db, router_modules, LLMRouter, LLMRouterError = _load_runtime_dependencies()
